...
description: Use when a task touches clinical safety for a quantum-assisted health tool — hazards, DCB0129/DCB0160, DTAC, CSCR, DPIA, the risk matrix, safety exports, or any claim about EndoTrack being safe to deploy.
---

# Quantum digital clinical safety

Use this skill when writing, editing or reviewing anything that appears in the `#safety`
section of the EndoTrack dashboard, in the printable Clinical Safety & Quantum Synergy
