...
EndoTrack is health IT intended to support a clinical pathway decision, so manufacturer
...
A trust deploying EndoTrack runs its own clinical risk management: local hazard
